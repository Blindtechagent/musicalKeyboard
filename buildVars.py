...
addon_info = {
	...
	"addon_name": "musicalKeyboard",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Musical Keyboard"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""Turn your typing keyboard into a musical keyboard.
                        Play notes using your computer keys and create melodies directly from your keyboard.
                        Toggle the musical keyboard on or off with NVDA+Shift+L."""),
	# version
	"addon_version": "1.0",
	# Author(s)
	"addon_author": "pawan kumar <pawanpianoartist@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/Blindtechagent/musicalKeyboard",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/Blindtechagent/musicalKeyboard",
